...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFF7F5]/60 via-white to-[#FFF7F5]/30 px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              已有账户？{" "}
              <Link href="/login" className="text-shu-600 hover:text-shu-700 font-medium">
                立即登录
              </Link>
            </p>
          </div>
