...
const CATEGORY_PRIORITY: Record<string, number> = {
  ...
  style: 2,       // 风格 - 二级
  service: 2,     // 服务 - 二级
  service_level: 2, // 服务等级 - 二级
  season: 3,      // 季节 - 三级
  location: 3,    // 地理 - 三级
  certification: 3, // 认证 - 三级
};
...
export default function SearchFilterSidebar({
  ...
  const activeFiltersCount = selectedTags.length + (priceRange[0] > 0 || priceRange[1] < maxPrice ? 1 : 0);
